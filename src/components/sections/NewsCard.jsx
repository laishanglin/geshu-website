...
export default function NewsCard({ item, index }) {
  ...
  return (
    <motion.a
      ...
      className="group relative block p-6 lg:p-8 rounded-2xl bg-[rgba(10,22,40,0.4)] border border-[rgba(59,130,246,0.06)] hover:bg-[rgba(10,22,40,0.7)] hover:border-brand-500/10 hover:-translate-y-1 transition-all duration-400 overflow-hidden"
    >
      {/* Subtle hover glow */}
      ...
      <div className="relative z-10">
        ...
        <span className="inline-flex items-center gap-1.5 text-sm text-brand-400/70 group-hover:text-brand-400 group-hover:gap-2.5 transition-all">
          了解更多
